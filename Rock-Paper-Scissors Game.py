...
elif (player_choice == "rock" or computer_choice == "rock") and (player_choice == "scissors" or computer_choice == "scissors"):
  if player_choice == "rock":
    print("Rock beats Scissors! You win!")
  else:
    print("Rock beats Scissors! You Lose! :(")
elif (player_choice == "scissors" or computer_choice == "scissors") and (player_choice == "paper" or computer_choice == "paper"):
